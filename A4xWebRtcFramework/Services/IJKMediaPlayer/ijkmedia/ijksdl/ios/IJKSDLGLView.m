...
- (void)setScaleFactor:(CGFloat)scaleFactor
{
    ...
    NSLog(@"setScaleFactor to invalidateRenderBuffer\n");
...
- (void)layoutSubviews
{
    ...
    if (self.isLivePlayer) {
        ...
        NSLog(@"layoutSubviews to invalidateRenderBuffer\n");
        [self invalidateRenderBuffer];
    } else {
       // 普通视频播放，不做处理 - 控制权交给业务层
    }
}
...
- (void)setContentMode:(UIViewContentMode)contentMode
{
    ...
    NSLog(@"setContentMode to invalidateRenderBuffer\n");
    [self invalidateRenderBuffer];
}
