...
RTC_OBJC_EXPORT
@protocol RTCAudioSourceDelegate <NSObject> 
-(void)audioSource:(RTCAudioSource*)source didAudioDataReceive:(NSData*)data
           samples:(NSInteger)samples_per_channel sampleRate:(NSInteger)sample_rate channels:(NSInteger)ch
...
/*callback received remote audio frame*/
@property(nonatomic, weak)id<RTCAudioSourceDelegate> delegate;
